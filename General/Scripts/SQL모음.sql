...
COMMENT ON COLUMN "NOTIFICATION"."NOTIFICATION_CONTENT" IS '알림내용(HTML 포함)';
...
CREATE TABLE "CHATTING_ROOM" (
	"CHATTING_ROOM_NO"	VARCHAR(255)		NOT NULL,
	"CREATE_DATE"	VARCHAR(255)	DEFAULT CURRENT_DATE	NOT NULL,
